...
function createtime() {
    ...
    var e = new Date("12/07/2022 00:00:00"), t = Math.trunc(234e8 + (now - e) / 1e3 * 17), a = (t / 1496e5).toFixed(6),
        o = new Date("12/07/2022 00:00:00"), r = (now - o) / 1e3 / 60 / 60 / 24, i = Math.floor(r),
